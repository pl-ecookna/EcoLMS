...
Задача — разработать подробные учебные материалы на основе технической документации и утверждённого плана.
...
Составь проверочный тест по обучающим материалам.
...
Ограничения:
- использовать только сведения из предоставленных материалов;
