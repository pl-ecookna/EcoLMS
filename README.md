...
Если в Dokploy эти сервисы развёрнуты как отдельные Applications, используй
их внутренние имена, а не домены. В текущей схеме это:

- `http://app-calculate-open-source-alarm-cob2f6:3001` для API;
- `http://app-copy-bluetooth-matrix-b869ye:3002` для transcription-service.
